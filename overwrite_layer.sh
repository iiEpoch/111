...
emon -collect-edp > /home/rocksdb_wjy/emonresult/write-layer-Dataset_${2}G_Value_${3}_DisWal_${5}.dat &

export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/lib
declare -i data=${2}\*1024\*1024\*1024\/${3}
taskset -c 0-31,64-95 ./db_bench_l --benchmarks="overwrite,stats,levelstats" \
--use_existing_db=1 \
--db=${1}/128B \
--db_paths_1=${6}/128B \
--db_paths_2=${1}/128B \
